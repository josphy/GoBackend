...
const (
	...
	DISTANCE = "200km"
	// Needs to update
	PROJECT_ID = "unique-hash-185822"
	BT_INSTANCE = "around-post"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://35.196.34.210:9200"
	BUCKET_NAME = "post-images-around185822"
)
...
func saveToGCS(ctx context.Context, r io.Reader, bucket, name string) (*storage.ObjectHandle, *storage.ObjectAttrs, error) {
	...
	b1 := client.Bucket(bucket)
	// Next check if the bucket exists
	if _, err = b1.Attrs(ctx); err != nil {
		return nil, nil, err
	}
